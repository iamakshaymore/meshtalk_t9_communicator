...
// Disable primary I2C bus to prevent scanning on GPIO 3/4 (used for keypad)
// #define I2C_SDA1 SDA     // Commented out to disable I2C scanning on port 1
